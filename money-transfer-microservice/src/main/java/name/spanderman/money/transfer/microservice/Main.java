...
public class Main {
     ...
     * @param port the port server will listen on
     * @return Grizzly HTTP server.
     */
    public static HttpServer startServer(int port) {
        // create a resource config that scans for JAX-RS resources and providers
        final ResourceConfig rc = new ResourceConfig().packages(Main.class.getPackage().getName()).register(JacksonFeature.class);
    ...
    /**
     * Starts Grizzly HTTP server on standard port ({@value #PORT}) exposing JAX-RS resources defined in this application.
     * @return Grizzly HTTP server.
     */
